...
public class CategoryEditView extends VBox {
    ...
    public CategoryEditView(CategoryViewParent parent, com.inapp.model.Category category) {
        this.parent = parent;
    ...
    private VBox createForm() {
        ...
        statusBox.setValue(service.statusLabel(category.getStatus()));
        statusBox.setMaxWidth(Double.MAX_VALUE);
        statusBox.setStyle(CategoryViewSupport.inputStyle());

        // Champ image avec bouton Parcourir (comme dans CategoryAddView)
        TextField imageField = new TextField(category.getImageUrl());
