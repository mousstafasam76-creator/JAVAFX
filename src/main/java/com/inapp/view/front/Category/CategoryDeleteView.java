...
public class CategoryDeleteView extends VBox {
    ...
    public CategoryDeleteView(Dashboard dashboard, int categoryId) {
    ...
    private void chargerCategorie() {
        // Simuler le chargement (remplacer par service)
        category = new com.inapp.model.Category(categoryId, "Téléphone", "Smartphones", "approved");
        productCount = 5;
    }
    ...
    private void deleteCategory() {
        ...
        // Appeler service.delete(categoryId, deleteProductsCheck.isSelected())
