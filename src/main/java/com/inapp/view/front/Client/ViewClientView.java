...
public class ViewClientView extends FrontView {
    ...
    protected Node createContent() {
        ...
        editBtn.setOnAction(e -> navigationManager.navigateTo("editClient?id=" + clientId));
        ...
        infoCard.setStyle(
            ...
            "-fx-border-width: 0 0 0 4; -fx-border-color: " + PRIMARY + " transparent transparent transparent;" +
